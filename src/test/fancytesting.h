...
struct typesetter_fancy_outputs_assurance g_fancy_tab_viewer_test_vector[] = {
    ...
    add_new_output_fancy_testing_step(purple_haze, html)
};

size_t g_fancy_tab_viewer_test_vector_nr = sizeof(g_fancy_tab_viewer_test_vector) / sizeof(g_fancy_tab_viewer_test_vector[0]);
