...
static FILE *pstypesetter_newps(const char *filepath) {
    ...
    fprintf(fp, "%%!PS-Adobe-3.0\n"
                ...
                "                            { def } { pop pop } ifelse\n"
                "                   } forall\n"
                "                   /Encoding exch def              %% defs for DPS\n"
                ...
                "/Times ISOLatin1Encoding /Times REENCODEFONT\n"
                "/Times-Bold ISOLatin1Encoding /Times-Bold REENCODEFONT\n"
                "/Times-Italic ISOLatin1Encoding /Times-Italic REENCODEFONT\n"
                "/arrowhead {\n"
                "\tgsave\n"
                "\t\tcurrentpoint\n"
                "\t\t4 2 roll exch\n"
