...
typedef enum _tulip_command_t {
    ...
    kTlpVibrato            = 0x00000200,
    kTlpSlideDown          = 0x00000400,
    kTlpSlideUp            = 0x00000800,
    kTlpHammerOn           = 0x00001000,
    kTlpPullOff            = 0x00002000,
    kTlpTunning            = 0x00004000,
    kTlpLiteral            = 0x00008000,
    kTlpSingleNote         = 0x00010000,
    kTlpSepBar             = 0x00020000,
    kTlpBend               = 0x00040000,
    kTlpReleaseBend        = 0x00080000,
